...
#+begin_src emacs-lisp
  ...
  (use-package lsp-treemacs
    :hook (lsp-treemacs-mode . (lambda () (keymap-local-set "<tab-bar> <mouse-movement>" #'ignore)))  ;; fix tab-bar mouse movement bell
    :after lsp)
...
#+begin_src emacs-lisp
  ...
  (add-hook 'c++-mode-hook 'lsp)
  (let ((clangd-path (executable-find "clangd")))
    (when clangd-path
...
#+begin_src emacs-lisp
  (use-package elpy
    :config (setq elpy-modules (delq 'elpy-module-highlight-indentation elpy-modules))
